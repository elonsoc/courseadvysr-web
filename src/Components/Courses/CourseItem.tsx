...
export default function CourseItem({ data, revealModal }: CourseItemProps) {
  ...
  return (
    ...
    >
      <div className=" mx-3 p-3 text-sm space-y-1 border-gray-400 border-2 rounded lg:transition lg:duration-200 lg:ease-in-out lg:hover:shadow-xl lg:transform lg:hover:-translate-y-1">
        <div className="grid grid-flow-col-dense auto-cols-auto">
          <div>
