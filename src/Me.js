import { Table, Navbar, Nav, Container, Col, Row, Spinner, Button } from 'react-bootstrap';
...
function Me() {
    ...
    const commitDeleteSelectedCourses = (e) => {
        ...
        selectedFlatRows.map(
            d => selected.push(d.original.courseRegistrationNumber)
        )
    ...
    return (
        <>
            ...
            <Container style={{ margin: 0 }} fluid>
                ...
                <Row>
                    <Col>
                        {isLoading ? <Spinner animation="border" /> : <h1 style={{ paddingLeft: 12 }}> {user}</h1>}
